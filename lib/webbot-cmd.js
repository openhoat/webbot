...
argv = yargs
  ...
  .example(util.format('%s -e live -s mywebtest -o \'{"desiredCapabilities":{"browserName": "firefox"}}\' -l trace', pkg.name), 'Execute my-super-test scenario on production with firefox and the log level trace')
  .argv;
