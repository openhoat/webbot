...
argv = yargs
  ...
  .example(util.format('%s -e live -s 1-simple -c \'{"browserName": "firefox"}\' -l trace', pkg.name), 'Execute my-super-test scenario on production with firefox and the log level trace')
  .argv;
